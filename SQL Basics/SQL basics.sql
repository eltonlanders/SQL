...
VALUES ('S001', 'Prashanth Jaya', 'A', '76', 'Computer Science');
SELECT * FROM studentdemo.Student;

INSERT INTO Student (StudentID, StudentName, grade, age, course) 
VALUES ('S002', 'Frank Solomon', 'B', 35, 'Physics'), 
('S003', 'Rachana Karia', 'B', 36, 'Electronics'), 
('S004', 'Ambika Prashanth', 'C', 35, 'Mathematics');
SELECT * FROM studentdemo.student;

#Building the PACKT_ONLINE_SHOP Database
...
#Inserting Values into the Customers Table of the PACKT_ ONLINE_SHOP Database
USE packt_online_shop;
...
#Inserting Values into the Products Table in the PACKT_ONLINE_ SHOP Database
use packt_online_shop; 
...
INSERT INTO newproducts ( ProductCategoryID, SupplierID, ProductName, NetRetailPrice, AvailableQuantity, WholesalePrice, UnitKGWeight, Notes )
VALUES
...
SELECT * FROM packt_online_shop.newproducts;
